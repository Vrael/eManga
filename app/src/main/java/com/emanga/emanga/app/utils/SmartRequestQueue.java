 ...
 */
public class SmartRequestQueue extends RequestQueue {
    ...
    /** The network dispatchers out from lifecycle */
    private NetworkDispatcher[] mDispatchersWait;
    ...
    public void startNetworkRequest() {
        stopNetworkRequest();  // Make sure any currently running dispatchers are stopped.
