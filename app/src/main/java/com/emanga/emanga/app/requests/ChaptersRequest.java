 ...
 */
public class ChaptersRequest extends JsonRequest<Chapter[]> {

    public ChaptersRequest(int method, String url, Response.Listener<Chapter[]> listener, Response.ErrorListener errorListener) {
    ...
    protected Response<Chapter[]> parseNetworkResponse(NetworkResponse response) {
        try {
            Log.d(ChaptersRequest.class.getSimpleName(), response.data.toString());
